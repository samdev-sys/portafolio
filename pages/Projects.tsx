  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="text-center mb-16 space-y-4 mt-20">
        <h2 className="text-4xl sm:text-5xl font-bold">Proyectos en Ejecución</h2>
        <p className="text-slate-400 max-w-2xl mx-auto">Proyectos actualmente en desarrollo.</p>
      </div>
          ...
          project.link ? (
            ...
            >
              ...
              <div className="p-8 space-y-4">
                ...
                <h3 className="text-2xl font-bold group-hover:text-cyan-400 transition-colors">{project.title}</h3>
                <p className="text-slate-400 line-clamp-2">{project.description}</p>
                <div className="pt-4 flex items-center text-slate-500 font-bold text-sm">
                  En Desarrollo
